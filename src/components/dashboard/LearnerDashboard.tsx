...
import { mockLearnerCourses, mockRecommendedCourses } from "../../data/mockData";
...
export const LearnerDashboard: React.FC = () => {
  ...
  const continuelearningCourse = mockLearnerCourses
      ...
      {filteredCourses.length > 0 ? (
        ...
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary-100 dark:bg-secondary-800 mb-4">
            <BookMarked className="h-8 w-8 text-secondary-600 dark:text-secondary-400" />
          </div>
